...
class Constraints {
    constructor(endpoint) {
        ...
        const rules = endpoint.constraints || {};
        for (const k of Object.keys(parameters)) {
            ...
            rules[k] = lodash_merge_1.default(rules[k], parameters[k].constraints || {});
        }
        ...
        if (anyOf in rules && !(anyOf in parameters)) {
            for (const k of Object.keys(rules.anyOf)) {
                rules[k] = lodash_merge_1.default(rules[k], { k: { anyOf: rules.anyOf } });
            }
            delete rules.anyOf;
        }
        // Check for anyOf object in constraints, skip if there exists parameter
        ...
        if (allOf in rules && !(allOf in parameters)) {
            for (const k of Object.keys(rules.allOf)) {
                rules[k] = lodash_merge_1.default(rules[k], { k: { allOf: rules.allOf } });
            }
            delete rules.anyOf;
        }
        ...
        if (oneOf in rules && !(oneOf in parameters)) {
            for (const k of Object.keys(rules.oneOf)) {
                rules[k] = lodash_merge_1.default(rules[k], { k: { oneOf: rules.oneOf } });
            }
            delete rules.oneOf;
        }
        this.rules = rules;
